...
public class Empresa  /*implements Archivable, Serializable*/{
   // Scanner entrada = new Scanner(System.in);
    ...
    /*  @Override
    public String getDataFileFormat(Producto p, Cliente c) {
        return p.getNombre()+";"
                +"T;"+p.getCodigo()+";"
                +p.getCantidad() + ";"
                +p.getValor()+ ";";
    ...
    @Override
    public String[] getDataForTable(Producto p, Cliente c) {
       String data[] = {p.getCodigo(), 
                        p.getNombre(), 
